...
var Tsserver = (function () {
    ...
    function Tsserver() {
        ...
        this.scanFileBetween = function (filePath, lineStartAndEnd, callback) {
            /**
     ...
     */
    Tsserver.prototype.implementation = function (filePath, line, column, callback) {
        var command = "{\"seq\":" + this.seq + ",\"type\":\"request\",\"command\":\"implementation\",\"arguments\":{\"file\":\"" + filePath + "\", \"line\":" + line + ", \"offset\": " + column + "}}\n";
        winston.log("data", "SENDING TO TSSERVER: \"" + command + "\"");
        this.proc.stdin.write(command);
        this.operations.push([callback, command]);
        this.seq++;
